                ...
                for entry in entrysplit:
                    if len(entry) == 2:
                        if entry[0] == 'Score':
                            ...
                            allignInfo[entry[0]] = entry[1].split('/')[0].strip() # Identities (number of residues aligned)
                        if entry[0] == 'Identities': 
                            allignInfo['IdentitiesPercentage'] = entry[1].split('(')[1].split('%')[0] # Identities %
